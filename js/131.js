...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "简单导航 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "简单导航 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "简单导航 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "简单导航 | Stay up late again";
}
//title问候语结束
